	...
	$d_rand 	= 'https://[l].wikipedia.org/w/api.php?action=query&list=random&rnnamespace=0&rnlimit=1&format=php';
		...
		$wikiurls[$l] = array(
						...
						'text' 	=>	array(
										...
										'template_check' 	=> 'Erlaube Links, die in seitlichen [Vorlage-]Boxen erscheinen - (führt zu schnelleren Ergebnissen und kürzeren Pfaden)',
										'article_direction' => 'Artikelreihenfolge umkehren',
										'skip' 				=> 'Artikel überspringen (optional - einer pro Zeile)',
										...
										'allowyears'		=> '4-stellige Jahre erlauben (wie 2008, 2009, etc.)',
										...
										'about'=>'Degrees of Wikipedia ist ein mehrsprachiges Werkzeug, um den Abstand zwischen Artikeln auf einer Live-Version von Wikipedia zu finden. Um es auszuprobieren, geben Sie unten zwei Begriffe ein und klicken Sie auf die Schaltfläche!',
									),
						'flags'=>array(
							'germany.png',
						),
